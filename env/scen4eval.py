...
#f AGENTS==2:
 #   limitedEvalnum = (TOPWALL*RIGHTWALL-2)*((TOPWALL*RIGHTWALL)-2-1)//100
  #  fullEvalnum = (TOPWALL*RIGHTWALL-2)*((TOPWALL*RIGHTWALL)-2-1)
#elif AGENTS==3:
 #   limitedEvalnum = (TOPWALL*RIGHTWALL-3)*((TOPWALL*RIGHTWALL)-1-3)*((TOPWALL*RIGHTWALL)-2-3)//100
  #  fullEvalnum = (TOPWALL*RIGHTWALL-3)*((TOPWALL*RIGHTWALL)-1-3)*((TOPWALL*RIGHTWALL)-2-3)
#elif AGENTS==4:
 #   limitedEvalnum = (TOPWALL*RIGHTWALL-4)*((TOPWALL*RIGHTWALL)-1-4)*((TOPWALL*RIGHTWALL)-2-4)*((TOPWALL*RIGHTWALL)-3-4)//100
  #  fullEvalnum = (TOPWALL*RIGHTWALL-4)*((TOPWALL*RIGHTWALL)-1-4)*((TOPWALL*RIGHTWALL)-2-4)*((TOPWALL*RIGHTWALL)-3-4)
#elif AGENTS==5:
 #   limitedEvalnum = (TOPWALL*RIGHTWALL-5)*((TOPWALL*RIGHTWALL)-1-5)*((TOPWALL*RIGHTWALL)-2-5)*((TOPWALL*RIGHTWALL)-3-5)*((TOPWALL*RIGHTWALL)-4-5)//100
  #  fullEvalnum = (TOPWALL*RIGHTWALL-5)*((TOPWALL*RIGHTWALL)-1-5)*((TOPWALL*RIGHTWALL)-2-5)*((TOPWALL*RIGHTWALL)-3-5)*((TOPWALL*RIGHTWALL)-4-5)

if LIMITED:
    evalNum = 100
    limitedEvalnum = evalNum
#else:
 #   evalNum = fullEvalnum
print("Limited:", LIMITED, "Eval Num:", evalNum)
...
if LIMITED:
    ...
    while len(second_locations) < limitedEvalnum: 
        ...
        if AGENTS>=3:
            x3, y3 = random.randint(0, RIGHTWALL-1), random.randint(ymin, RIGHTWALL-1)
        if AGENTS>=4:
            x4, y4 = random.randint(0, RIGHTWALL-1), random.randint(ymin, RIGHTWALL-1)
        if AGENTS>=5:
            x5, y5 = random.randint(0, RIGHTWALL-1), random.randint(ymin, RIGHTWALL-1)
        ...
        if AGENTS==3:
            if (x1, y1) != (x2, y2) and (x1, y1) != (x3, y3) and (x2, y2) != (x3, y3):
                # Ensure neither point is (0, 0) or (6, 0)
                if (x1, y1) not in taken_locs and (x2, y2) not in taken_locs and (x3, y3) not in taken_locs:
                    first_locations.append((x1, y1))
                    second_locations.append((x2, y2))
                    third_locations.append((x3, y3))
        if AGENTS==4:
            if (x1, y1) != (x2, y2) and (x1, y1) != (x3, y3) and (x2, y2) != (x3, y3) and (x1, y1) != (x4, y4) and (x2, y2) != (x4, y4) and (x3, y3) != (x4, y4):
                # Ensure neither point is (0, 0) or (6, 0)
                if (x1, y1) not in taken_locs and (x2, y2) not in taken_locs and (x3, y3) not in taken_locs and (x4, y4) not in taken_locs:
                    first_locations.append((x1, y1))
                    second_locations.append((x2, y2))
                    third_locations.append((x3, y3))
                    fourth_locations.append((x4, y4))
        if AGENTS==5:
            if (x1, y1) != (x2, y2) and (x1, y1) != (x3, y3) and (x2, y2) != (x3, y3) and (x1, y1) != (x4, y4) and (x2, y2) != (x4, y4) and (x3, y3) != (x4, y4) and (x1, y1) != (x5, y5) and (x2, y2) != (x5, y5) and (x3, y3) != (x5, y5) and (x4, y4) != (x5, y5):
                # Ensure neither point is (0, 0) or (6, 0)
                if (x1, y1) not in taken_locs and (x2, y2) not in taken_locs and (x3, y3) not in taken_locs and (x4, y4) not in taken_locs and (x5, y5) not in taken_locs:
                    first_locations.append((x1, y1))
                    second_locations.append((x2, y2))
                    third_locations.append((x3, y3))
                    fourth_locations.append((x4, y4))
                    fifth_locations.append((x5, y5))
else:
    print("FULL EVAL")
...
print("Number of limited third locations:", len(third_locations))
print("Number of limited fourth locations:", len(fourth_locations))
print("Number of limited fifth locations:", len(fifth_locations))
...
class CustomEnvironment(gym.Env):
    ...
    def reset(self, scen=0, randomReset=False):
        ...
        third_drone_locations = third_locations
        fourth_drone_locations = fourth_locations
        fifth_drone_locations = fifth_locations
        drone_num = 1
        for drone in self.drones:
            if randomReset:
                ...
                if drone_num == 1:
                    ...
                    drone.x = third_drone_locations[index][0]
                    drone.y = third_drone_locations[index][1]
                elif drone_num == 4:
                    drone.x = fourth_drone_locations[index][0]
                    drone.y = fourth_drone_locations[index][1]
                elif drone_num == 5:
                    drone.x = fifth_drone_locations[index][0]
                    drone.y = fifth_drone_locations[index][1]
                drone_num += 1
