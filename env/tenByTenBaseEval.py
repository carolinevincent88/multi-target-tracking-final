...
while len(second_locations) < 2376:
    x1, y1 = random.randint(0, RIGHTWALL-1), random.randint(0, TOPWALL-1)
    x2, y2 = random.randint(0, RIGHTWALL-1), random.randint(0, TOPWALL-1)
...
print("Number of limited ten by ten eval first locations:", len(first_locations))
print("Number of limited ten by ten eval second locations:", len(second_locations))
